...
All work must stay inside `mlops-project/` unless a task explicitly says otherwise.
...
- Assignment: `../MLOps_project.pdf`
- Prior dataset decision: `../dataset_recommendations.md`
...
Follow the Kedro-style organization used in the practical classes:
...
Use the package name `green_taxi_mlops` unless the user chooses another name.
